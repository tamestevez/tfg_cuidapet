...
class InsurancePolice(models.Model):
    ...
    national_helpline=models.CharField(max_length=25, verbose_name="Teléfono nacional")
    helpline_abroad=models.CharField(max_length=25, verbose_name="Teléfono internacional")
    nationality=models.CharField(max_length=2, choices=NATIONALITY, default="SPAIN", verbose_name="Nacionalidad")
