...
class MedicalHistory(models.Model):
    ...
    allergy = MultiSelectField(
        max_length=25, choices=ALERGY, null=True, verbose_name="Alergias"
    )
...
class Disease(models.Model):
    ...
    medical_history = models.ForeignKey(
        MedicalHistory, on_delete=models.CASCADE
    )
...
class Medicine(models.Model):
    ...
    batch_number = models.CharField(
        max_length=7, verbose_name="Número de lote"
    )
